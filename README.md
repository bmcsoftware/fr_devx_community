...
<p align="justify">La communauté DevX France est hébergée dans un espace GitHub au sein de l'organisation BMC Software. Elle exploite le système des Pages GitHub pour offrir une expérience de navigation s'approchant d'un blog. Les éléments composant les pages sont créées par les admins de l'espace sur la base des contenus partagés par les membres de la communauté dans GitHub ainsi que des éléments externes telles que les idées soumises sur le site de la communauté BMC.</p>
...
- [Ideas](https://github.com/bmcsoftware/fr_devx_community/discussions/categories/ideas) - Pour la co-construction d'idées à promouvoir auprès des product managers BMC AMI DevX
- [Q&A](https://github.com/bmcsoftware/fr_devx_community/discussions/categories/q-a) - Pour toute question adressée à la communauté
- [Show and Tell](https://github.com/bmcsoftware/fr_devx_community/discussions/categories/show-and-tell) - Pour le partage d'astuces avec la communauté
- [General](https://github.com/bmcsoftware/fr_devx_community/discussions/categories/general) - Pour tout ce qui ne rentre pas dans les catégories précédentes
